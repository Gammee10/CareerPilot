...
ALTER TABLE signin_links ADD COLUMN IF NOT EXISTS purpose text NOT NULL DEFAULT 'signin'
...
ALTER TABLE search_terms ADD COLUMN IF NOT EXISTS expanded_from text;
